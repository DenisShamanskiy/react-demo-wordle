...
const Input: FC<IInputProps> = ({
  ...
  const getLabelClasses = (): string => 'mt-1.5 md:mt-3'
  ...
  return (
    <>
      <input
        ...
        className={`peer relative z-10 box-border h-10 w-full border-none bg-transparent text-base font-semibold tracking-wider text-w-black outline-none autofill:rounded-full dark:text-w-white-dark autofill:dark:border-none dark:focus:text-w-white-dark md:h-12 md:text-lg ${computedClasses}`}
      ></input>
      <span
