...
const CustomLink: FC<CustomLinkProps> = ({ to, icon, children }) => {
  ...
  return children ? (
    <NavLink to={to}>
      <div className='relative flex h-12 items-center justify-center rounded-2xl border-2 border-w-grey-tone-2 text-sm font-semibold tracking-wider text-w-quartz transition-all duration-300 hover:scale-105 dark:border-w-grey-tone-3 dark:text-w-white-dark md:text-base'>
