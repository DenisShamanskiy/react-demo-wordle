...
const Modal: React.FC<ModalProps> = ( {children} ) => {
    ...
    return (
      <div className={`modal ${window === "Rules" ? "items-end smModal:items-center" : "items-center"} ${ open && "modal_active" } ${ window === "GameLost" && "bg-red-500/60" }`} onClick={() => dispatch(activeModal({open: false, window: window}))}>
