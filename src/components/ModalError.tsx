...
export const ModalError = () => {
  ...
  const { message } = useAppSelector((state) => state.modal.error)
  ...
  return (
    <div className='w-72 select-none md:w-80'>
      ...
      <p
        ...
        className='mt-4 mb-8 text-center text-sm font-semibold text-w-quartz dark:text-w-white-dark md:mt-5 md:mb-10 md:text-base'
      ></p>
